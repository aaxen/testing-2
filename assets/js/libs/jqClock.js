 ...
 *    $("#mydiv").clock({calenderLocation:"#id/.class"});// add by km
 */
  ...
  return this.each(function(){
    ...
    updateClock = function(el,myoptions) {
      ...
      if(myoptions=="destroy"){ clearTimeout(t[el_id]); }
        ...
        dt=addleadingzero(mytimestamp.getDate()),
        ...
        if(myoptions.calendar!="false") {
		  ...
		  //km format
            calend = '<div><label class="lbl_MainDate">'+dt+'</label> <label class="lbl_MainMonth">'+locale[myoptions.langSet].months[mo]+'</label></div><div class="divDay"><label class="lbl_Day">'+locale[myoptions.langSet].weekdays[dy]+'</label></div>';
          }
          else {
		  //ori format
        ...
        if(myoptions.calenderLocation){
            $(myoptions.calenderLocation).html(calend);
            $(el).html("<span class='clocktime'>"+h+":"+m+(options.seconds == "true"?":"+s:"")+ap+"</span>");
	}else{
